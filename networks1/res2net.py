...
def res2net50_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], baseWidth=26, scale=4, **kwargs)
    if pretrained:
        model_state = torch.load('/sdata/yixin.zhang/program/pythonfolder/colorful_model/res2net50_v1b_26w_4s-3cf99910.pth')
...
if __name__ == '__main__':
    net = res2net50_v1b_26w_4s().cuda()
    input = torch.randn(1,3,224,224).cuda()# 1, 3, 224, 224
