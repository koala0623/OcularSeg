...
class M2SNet(nn.Module):
    ...
    def forward(self, x):                # bs,3,224,224
        ...
        x1_dem_1 = self.x1_dem_1(x1)     # bs,64,112,112
        ...
        x5_dem_1_up_a1= F.upsample(x5_dem_1, size=x1.size()[2:], mode='bilinear')      # bs,64,112,112  ***
        ...
        #      + abs(x5_4_3_up_c1 - x4_3_2)+abs(x5_dem_1_up_c1_map1-x4_3_2_map1)+abs(x5_dem_1_up_c1_map2-x4_3_2_map2)
        #       )
        x5_4_3_2 = self.x5_x4_x3_x2(
            abs(x5_4_3_up - x4_3_2)+abs(x5_4_3_up_map1-x4_3_2_map1)+abs(x5_4_3_up_map2-x4_3_2_map2)
              )
